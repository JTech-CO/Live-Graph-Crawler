...
⚠️ **중요**: 프론트엔드에서 API 키를 직접 사용하면 브라우저에 노출됩니다.

- API 키는 브라우저 로컬 스토리지에 저장됩니다
- Google API 키에 **도메인 제한** 설정을 강력히 권장합니다
- 공용 컴퓨터 사용 시 사용 후 "모두 삭제" 버튼으로 키를 삭제하세요
- 프로덕션 환경에서는 API 키 노출을 최소화하기 위한 추가 보안 조치를 고려하세요
